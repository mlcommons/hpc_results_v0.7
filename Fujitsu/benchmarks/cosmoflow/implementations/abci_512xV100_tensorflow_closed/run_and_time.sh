...
cd ../implementation_abci

DataDir="/groups1/gca50115/tabuchi/cosmoflow/partial_small_dataset/cosmoUniverse_2019_05_4parE_tf_64"
StageDir="/dev/shm"

mpirun -np 512 --mca btl openib -mca pml ob1 -mca mpi_warn_on_fork 0 \
python3 train.py configs/cosmo_closed_128node.yaml --data-dir $DataDir --stage-dir $StageDir --rank-gpu -d
