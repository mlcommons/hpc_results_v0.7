...
def construct_dataset(file_dir, n_samples, batch_size, n_epochs,
    ...
    def data_fn():
        ...
        data = data.apply(dataset_fn).map(parse_data, num_parallel_calls=4)
...
def get_datasets(data_dir, sample_shape, n_train, n_valid,
                 ...
                 prefetch=4, apply_log=False, prestaged=False, seed=-1, do_augmentation=False, validation_batch_size=None, train_staging_dup_factor=1, use_cache=False, cache_as_fp32=False):
    ...
    train_dataset_args = dict(batch_size=batch_size, n_epochs=n_epochs,
                              ...
                              apply_log=apply_log, prefetch=prefetch, dist=dist, use_cache=use_cache, cache_as_fp32=cache_as_fp32)
