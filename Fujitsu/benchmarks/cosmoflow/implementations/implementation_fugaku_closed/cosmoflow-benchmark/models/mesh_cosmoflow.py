...
def build_model(input_shape, target_size,
    ...
    model = partial(model_fn, dropout=dropout, optimizer=optimizer, lr_scheduler=lr_scheduler, batch_size=batch_size, mesh_shape=mesh_shape, seed=seed, save_conf=save_conf)

    return model


def cosmo_model(image, labels, mesh, mode,
                batch_size, mesh_shape, dropout, seed):
  """The model.
...
def model_fn(features, labels, mode, params,
             dropout, optimizer, lr_scheduler, batch_size, mesh_shape, seed, save_conf):
  ...
  logits, loss = cosmo_model(features, labels, mesh, mode,
                             batch_size=batch_size, mesh_shape=mesh_shape, dropout=dropout, seed=seed)
