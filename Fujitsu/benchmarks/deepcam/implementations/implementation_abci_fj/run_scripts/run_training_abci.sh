...
export CAC_STOP_LAYER_CHANGE_EPOCH_NUM=-1
export CAC_STOP_LAYER_NUM=-1

export CAC_BRAKING_DISTANCE=10
export CAC_BRAKING_FACTOR=10
export CAC_FINISH_LR=1.0e-4

#export SET_STOP_LAYER_NUM=1:99999
#export SET_STOP_LAYER_THR=1:0
export SET_STOP_LAYER_NUM=1:51,2:99,3:151,4:195,5:227
export SET_STOP_LAYER_THR=1:24.4,2:22.27,3:20.14,4:20.66,5:20.77
# ./qrsh.sh 1 Test Threshold
#export SET_STOP_LAYER_THR=1:26.98,2:26.98,3:26.98,4:26.98,5:26.98
